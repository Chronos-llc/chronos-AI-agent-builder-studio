...
def upgrade():
    ...
    if not _table_exists(inspector, 'playwright_browser_sessions'):
    ...
    if not _index_exists(inspector, 'playwright_browser_sessions', op.f('ix_playwright_browser_sessions_id')):
        op.create_index(op.f('ix_playwright_browser_sessions_id'), 'playwright_browser_sessions', ['id'], unique=False)
    if not _index_exists(inspector, 'playwright_browser_sessions', op.f('ix_playwright_browser_sessions_session_id')):
        op.create_index(op.f('ix_playwright_browser_sessions_session_id'), 'playwright_browser_sessions', ['session_id'], unique=True)
    if not _index_exists(inspector, 'playwright_browser_sessions', op.f('ix_playwright_browser_sessions_user_id')):
    ...
    if not _table_exists(inspector, 'playwright_automation_tasks'):
        ...
        inspector = sa.inspect(op.get_bind())
    if not _index_exists(inspector, 'playwright_automation_tasks', op.f('ix_playwright_automation_tasks_id')):
        op.create_index(op.f('ix_playwright_automation_tasks_id'), 'playwright_automation_tasks', ['id'], unique=False)
    if not _index_exists(inspector, 'playwright_automation_tasks', op.f('ix_playwright_automation_tasks_task_id')):
        op.create_index(op.f('ix_playwright_automation_tasks_task_id'), 'playwright_automation_tasks', ['task_id'], unique=True)
    if not _index_exists(inspector, 'playwright_automation_tasks', op.f('ix_playwright_automation_tasks_session_id')):
        op.create_index(op.f('ix_playwright_automation_tasks_session_id'), 'playwright_automation_tasks', ['session_id'], unique=False)
    if not _index_exists(inspector, 'playwright_automation_tasks', op.f('ix_playwright_automation_tasks_user_id')):
    ...
    if not _table_exists(inspector, 'playwright_artifacts'):
        ...
        inspector = sa.inspect(op.get_bind())
    if not _index_exists(inspector, 'playwright_artifacts', op.f('ix_playwright_artifacts_id')):
        op.create_index(op.f('ix_playwright_artifacts_id'), 'playwright_artifacts', ['id'], unique=False)
    if not _index_exists(inspector, 'playwright_artifacts', op.f('ix_playwright_artifacts_artifact_id')):
        op.create_index(op.f('ix_playwright_artifacts_artifact_id'), 'playwright_artifacts', ['artifact_id'], unique=True)
    if not _index_exists(inspector, 'playwright_artifacts', op.f('ix_playwright_artifacts_session_id')):
        op.create_index(op.f('ix_playwright_artifacts_session_id'), 'playwright_artifacts', ['session_id'], unique=False)
    if not _index_exists(inspector, 'playwright_artifacts', op.f('ix_playwright_artifacts_task_id')):
    ...
    if not _table_exists(inspector, 'playwright_browser_pools'):
        ...
        inspector = sa.inspect(op.get_bind())
    if not _index_exists(inspector, 'playwright_browser_pools', op.f('ix_playwright_browser_pools_id')):
        op.create_index(op.f('ix_playwright_browser_pools_id'), 'playwright_browser_pools', ['id'], unique=False)
    if not _index_exists(inspector, 'playwright_browser_pools', op.f('ix_playwright_browser_pools_pool_id')):
    ...
    if not _table_exists(inspector, 'playwright_browser_pool_instances'):
        ...
        inspector = sa.inspect(op.get_bind())
    if not _index_exists(inspector, 'playwright_browser_pool_instances', op.f('ix_playwright_browser_pool_instances_id')):
        op.create_index(op.f('ix_playwright_browser_pool_instances_id'), 'playwright_browser_pool_instances', ['id'], unique=False)
    if not _index_exists(inspector, 'playwright_browser_pool_instances', op.f('ix_playwright_browser_pool_instances_instance_id')):
    ...
    if not _index_exists(inspector, 'playwright_browser_pool_instances', op.f('ix_playwright_browser_pool_instances_pool_id')):
    ...
    if not _table_exists(inspector, 'playwright_security_rules'):
        ...
        inspector = sa.inspect(op.get_bind())
    if not _index_exists(inspector, 'playwright_security_rules', op.f('ix_playwright_security_rules_id')):
        op.create_index(op.f('ix_playwright_security_rules_id'), 'playwright_security_rules', ['id'], unique=False)
    if not _index_exists(inspector, 'playwright_security_rules', op.f('ix_playwright_security_rules_rule_id')):
    ...
    if not _index_exists(inspector, 'playwright_artifacts', 'ix_playwright_artifacts_created_at'):
        op.create_index('ix_playwright_artifacts_created_at', 'playwright_artifacts', ['created_at'], unique=False)
    if not _index_exists(inspector, 'playwright_automation_tasks', 'ix_playwright_automation_tasks_status'):
        op.create_index('ix_playwright_automation_tasks_status', 'playwright_automation_tasks', ['status'], unique=False)
    if not _index_exists(inspector, 'playwright_automation_tasks', 'ix_playwright_automation_tasks_created_at'):
        op.create_index('ix_playwright_automation_tasks_created_at', 'playwright_automation_tasks', ['created_at'], unique=False)
    if not _index_exists(inspector, 'playwright_browser_sessions', 'ix_playwright_browser_sessions_status'):
        op.create_index('ix_playwright_browser_sessions_status', 'playwright_browser_sessions', ['status'], unique=False)
    if not _index_exists(inspector, 'playwright_browser_sessions', 'ix_playwright_browser_sessions_created_at'):
