...
class UserProfileOnboardingRequest(BaseModel):
...
class UserFuzzyOnboardingRequest(BaseModel):
...
class UserProfileResponse(UserProfileBase):
    ...
    fuzzy_onboarding_state: str
    fuzzy_onboarding_completed_at: Optional[datetime] = None
    fuzzy_onboarding_skipped_at: Optional[datetime] = None
    created_at: datetime
    updated_at: datetime
