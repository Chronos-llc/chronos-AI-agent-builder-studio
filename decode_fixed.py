...
# Fix 1: Remove extra quote in events_url: %22events_url%22%22%3A -> %22events_url%22%3A
fixed = re.sub(r'%22events_url%22%22%3A', '%22events_url%22%3A', encoded)

# Fix 2: Replace asterisk in owner's url field with "https:"
# Pattern: %22url%22%3A%2A (i.e., "url":*)
# Replacement: %22url%22%3Ahttps%3A (i.e., "url":"https:)
fixed = re.sub(r'%22url%22%3A%2A', '%22url%22%3Ahttps%3A', fixed)
